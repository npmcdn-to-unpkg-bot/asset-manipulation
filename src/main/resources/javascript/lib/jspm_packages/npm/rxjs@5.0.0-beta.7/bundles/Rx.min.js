...
(function(process) {
  ...
  System.register("rxjs/util/root", [], !0, function(require, e, t) {
  ...
  }), System.register("rxjs/util/UnsubscriptionError", [], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        o = function(e) {
          function t(t) {
            e.call(this), this.errors = t, this.name = "UnsubscriptionError", this.message = t ? t.length + " errors occurred during unsubscription:\n" + t.map(function(e, t) {
              return t + 1 + ") " + e.toString();
            }).join("\n") : "";
          }
          return i(t, e), t;
        }(Error);
    return e.UnsubscriptionError = o, r.define = s, t.exports;
  ...
  }), System.register("ponyfill", [], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    return r.define = void 0, t.exports = function(e) {
      var t,
          r = e.Symbol;
    ...
    function r(e) {
      ...
      if (!p) {
        ...
        h.source = r;
        var d = c.tryCatch(n).apply(this, a.concat(h));
        d === l.errorObject && p.error(l.errorObject.e);
      }
      t.add(p.subscribe(o));
    }
    function s(e) {
    ...
    var u = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        d = require('../symbol/iterator'),
        f = require('../util/errorObject'),
        v = function(e) {
          function t(t, s, i, o) {
          ...
          return u(t, e), t.create = function(e, r, s, i) {
            ...
            var a = o.next();
            return a.done ? void n.complete() : (i ? (a = b.tryCatch(i).call(s, a.value, t), a === f.errorObject ? (e.error = f.errorObject.e, e.hasError = !0) : (n.next(a), e.index = t + 1)) : (n.next(a.value), e.index = t + 1), void(n.isUnsubscribed || this.schedule(e)));
          }, t.prototype._subscribe = function(e) {
            var r = 0,
                s = this,
                i = s.iterator,
            ...
            for (; ; ) {
              ...
              if (o) {
                if (u = b.tryCatch(o).call(n, u.value, r++), u === f.errorObject) {
                  e.error(f.errorObject.e);
                  break;
                }
                e.next(u);
              } else
    ...
    return e.FromEventObservable = d, a.define = u, t.exports;
  ...
  }), System.register("rxjs/observable/GenerateObservable", ["rxjs/Observable", "rxjs/util/isScheduler"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        o = require('../Observable'),
        n = require('../util/isScheduler'),
        a = function(e) {
          return e;
        },
        u = function(e) {
          function t(t, r, s, i, o) {
            e.call(this), this.initialState = t, this.condition = r, this.iterate = s, this.resultSelector = i, this.scheduler = o;
          }
          return i(t, e), t.create = function(e, r, s, i, o) {
            return 1 == arguments.length ? new t(e.initialState, e.condition, e.iterate, e.resultSelector || a, e.scheduler) : void 0 === i || n.isScheduler(i) ? new t(e, r, s, a, i) : new t(e, r, s, i, o);
          }, t.prototype._subscribe = function(e) {
            var r = this.initialState;
            if (this.scheduler)
              return this.scheduler.schedule(t.dispatch, 0, {
                subscriber: e,
            ...
            if (!t.isUnsubscribed) {
              ...
              if (!t.isUnsubscribed && (t.next(o), !t.isUnsubscribed))
                return this.schedule(e);
            }
          }, t;
        }(o.Observable);
    return e.GenerateObservable = u, r.define = s, t.exports;
    ...
    var h = function() {
      ...
      return e.prototype.call = function(e, t) {
        return t._subscribe(new d(e, this.project));
      }, e;
    }();
    e.ZipOperator = h;
    var d = function(e) {
      ...
      return n(t, e), t.prototype._next = function(e) {
        var t = this.iterators,
            r = this.index++;
        u.isArray(e) ? t.push(new v(e)) : "function" == typeof e[p.$$iterator] ? t.push(new f(e[p.$$iterator]())) : t.push(new x(this.destination, this, e, r));
      }, t.prototype._complete = function() {
    ...
    return n.define = a, t.exports;
  }), System.register("rxjs/operator/bufferToggle", ["rxjs/Subscription", "rxjs/util/subscribeToResult", "rxjs/OuterSubscriber"], !0, function(require, e, t) {
    function r(e, t) {
    ...
    var c = function() {
      ...
      return e.prototype.call = function(e, t) {
        return t._subscribe(new l(e, this.openings, this.closingSelector));
      }, e;
    }(),
        l = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.openings = r, this.closingSelector = s, this.contexts = [], this.add(a.subscribeToResult(this, r));
          }
          return o(t, e), t.prototype._next = function(e) {
            ...
            var t = this.contexts,
                r = [],
                s = new n.Subscription,
                i = {
                  buffer: r,
                  subscription: s
                };
            t.push(i);
            var o = a.subscribeToResult(this, e, i);
            !o || o.isUnsubscribed ? this.closeBuffer(i) : (o.context = i, this.add(o), s.add(o));
          }, t;
        }(u.OuterSubscriber);
    return s.define = i, t.exports;
    ...
    var a = function() {
      ...
      return e.prototype.call = function(e, t) {
        return t._subscribe(new u(e, this.predicate, this.thisArg));
      }, e;
    }(),
        u = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.predicate = r, this.thisArg = s, this.count = 0, this.predicate = r;
          }
          return o(t, e), t.prototype._next = function(e) {
            var t;
            try {
    ...
    var c = function() {
      ...
      return e.prototype.call = function(e, t) {
        return t._subscribe(new l(e, this.duration, this.scheduler));
      }, e;
    }(),
        l = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.duration = r, this.scheduler = s, this.hasValue = !1;
          }
          return n(t, e), t.prototype._next = function(e) {
            this.value = e, this.hasValue = !0, this.throttled || this.add(this.throttled = this.scheduler.schedule(s, this.duration, this));
          }, t.prototype.clearThrottle = function() {
            var e = this,
                t = e.value,
                r = e.hasValue,
    ...
    function r(e, t) {
      return this.lift(new a(e, t, this));
    }
    var s = System.global,
        i = s.define;
    s.define = void 0;
    ...
    var c = function() {
      ...
      return e.prototype.call = function(e, t) {
        return t._subscribe(new l(e, this.period, this.scheduler));
      }, e;
    }(),
        l = function(e) {
          function t(t, r, i) {
            e.call(this, t), this.period = r, this.scheduler = i, this.hasValue = !1, this.add(i.schedule(s, r, {
              subscriber: this,
              period: r
            }));
          }
    ...
    var a = function() {
      ...
      return e.prototype.call = function(e, t) {
        ...
        u = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.accumulator = r, this.index = 0, this.accumulatorSet = !1, this.seed = s, this.accumulatorSet = "undefined" != typeof s;
          }
    ...
    var c = function() {
      ...
      return e.prototype.call = function(e, t) {
        ...
        l = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.duration = r, this.scheduler = s;
          }
          return n(t, e), t.prototype._next = function(e) {
            this.throttled || (this.add(this.throttled = this.scheduler.schedule(s, this.duration, {subscriber: this})), this.destination.next(e));
          }, t.prototype.clearThrottle = function() {
            var e = this.throttled;
        ...
        h = function(e) {
          ...
          return o(t, e), t.prototype._next = function(e) {
            ...
            if (e === this.openings) {
              ...
              var f = b.subscribeToResult(this, l, d);
              f.isUnsubscribed ? this.closeWindow(this.contexts.length - 1) : (f.context = d, h.add(f)), this.destination.next(p);
            } else
  ...
  }), System.register("symbol-observable", ["ponyfill"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    return r.define = void 0, t.exports = require('ponyfill')(r || window || this), r.define = s, t.exports;
  ...
  }), System.register("rxjs/util/subscribeToResult", ["rxjs/util/root", "rxjs/util/isArray", "rxjs/util/isPromise", "rxjs/Observable", "rxjs/symbol/iterator", "rxjs/InnerSubscriber", "symbol-observable"], !0, function(require, e, t) {
    function r(e, t, r, s) {
      ...
      if (!i.isUnsubscribed) {
        ...
        if (n.isArray(t)) {
          ...
          if ("function" == typeof t[c.$$iterator]) {
            ...
            i.isUnsubscribed || i.complete();
          } else if ("function" == typeof t[b]) {
            var x = t[b]();
            if ("function" == typeof x.subscribe)
              return x.subscribe(new l.InnerSubscriber(e, r, s));
    ...
    return e.ObserveOnMessage = l, s.define = i, t.exports;
  ...
  }), System.register("rxjs/add/observable/generate", ["rxjs/Observable", "rxjs/observable/GenerateObservable"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../Observable'),
        o = require('../observable/GenerateObservable');
    return i.Observable.generate = o.GenerateObservable.create, r.define = s, t.exports;
  ...
  }), System.register("rxjs/Subscription", ["rxjs/util/isArray", "rxjs/util/isObject", "rxjs/util/isFunction", "rxjs/util/tryCatch", "rxjs/util/errorObject", "rxjs/util/UnsubscriptionError"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../util/isArray'),
        o = require('../util/isObject'),
        n = require('../util/isFunction'),
        a = require('../util/tryCatch'),
        u = require('../util/errorObject'),
        c = require('../util/UnsubscriptionError'),
        l = function() {
          function e(e) {
          ...
          return e.prototype.unsubscribe = function() {
            ...
            if (!this.isUnsubscribed) {
              ...
              var r = this,
                  s = r._unsubscribe,
                  l = r._subscriptions;
              if (this._subscriptions = null, n.isFunction(s)) {
                var b = a.tryCatch(s).call(this);
                b === u.errorObject && (t = !0, (e = e || []).push(u.errorObject.e));
              }
              if (i.isArray(l))
                for (var p = -1,
                    h = l.length; ++p < h; ) {
                  var d = l[p];
                  if (o.isObject(d)) {
                    var b = a.tryCatch(d.unsubscribe).call(d);
                    if (b === u.errorObject) {
                      t = !0, e = e || [];
                      var f = u.errorObject.e;
                      f instanceof c.UnsubscriptionError ? e = e.concat(f.errors) : e.push(f);
                    }
                  }
                }
              if (t)
    ...
    return e.Subscription = l, r.define = s, t.exports;
    ...
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        h = require('../symbol/iterator'),
        d = require('../Observable'),
        f = require('../operator/observeOn'),
        v = require('symbol-observable'),
        x = function(e) {
          return e && "number" == typeof e.length;
        },
        y = function(e) {
          ...
          return i(t, e), t.create = function(e, r, s, i) {
            var f = null,
                y = null;
            if (n.isFunction(r) ? (f = i || null, y = r) : u.isScheduler(f) && (f = r), null != e) {
              if ("function" == typeof e[v])
                return e instanceof d.Observable && !f ? e : new t(e, f);
              if (o.isArray(e))
                return new b.ArrayObservable(e, f);
              if (a.isPromise(e))
                return new c.PromiseObservable(e, f);
              if ("function" == typeof e[h.$$iterator] || "string" == typeof e)
                return new l.IteratorObservable(e, null, null, f);
              if (x(e))
                return new p.ArrayLikeObservable(e, y, s, f);
            }
            throw new TypeError((null !== e && typeof e || e) + " is not observable");
          }, t.prototype._subscribe = function(e) {
            var t = this.ish,
                r = this.scheduler;
            return null == r ? t[v]().subscribe(e) : t[v]().subscribe(new f.ObserveOnSubscriber(e, r, 0));
          }, t;
        }(d.Observable);
      ...
      return e.prototype.call = function(e, t) {
        ...
        h = function(e) {
          ...
          return o(t, e), t.prototype._next = function(e) {
            ...
            var r;
            try {
              r = this.durationSelector(new f(e, t));
            } catch (s) {
              return void this.error(s);
            }
  ...
  }), System.register("rxjs/Observable", ["rxjs/util/root", "rxjs/util/toSubscriber", "symbol-observable"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../util/root'),
        o = require('../util/toSubscriber'),
        n = require('symbol-observable'),
        a = function() {
          function e(e) {
    ...
    var d = require('../util/EmptyError');
    e.EmptyError = d.EmptyError;
    var f = require('../util/ArgumentOutOfRangeError');
    ...
    var x = require('../util/UnsubscriptionError');
    e.UnsubscriptionError = x.UnsubscriptionError;
    var y = require('../scheduler/asap'),
        j = require('../scheduler/async'),
        m = require('../scheduler/queue'),
        S = require('../symbol/rxSubscriber'),
        O = require('../symbol/iterator'),
        g = require('symbol-observable'),
        w = {
          asap: y.asap,
          async: j.async,
          queue: m.queue
    ...
    e.Scheduler = w;
    var _ = {
      rxSubscriber: S.$$rxSubscriber,
      observable: g,
      iterator: O.$$iterator
    };
    return e.Symbol = _, r.define = s, t.exports;
  });
})(require('process'));
